...
The algorithm takes a list of all the elements of the sequence, and continually 
...
The modern version of the algorithm takes time proportional to the number of items being 
